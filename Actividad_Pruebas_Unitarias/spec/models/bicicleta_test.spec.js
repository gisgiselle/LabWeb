...
describe('Testing bicicletas', function(){
    ...
    describe('Bicicleta.createInstance', ()=>{
        it('crea una instancia de la bicicleta', ()=>{
            let bici = Bicicleta.createInstance(1, 'white', 'aaa', [19.28, -99.13])

            expect(bici.code).toBe(1)
            expect(bici.color).toBe('white')
            expect(bici.modelo).toBe('aaa')
    ...
    describe('Bicicletas.add', ()=>{
        it('agrega una bici', (done)=>{
            let bici = new Bicicleta({code: 1, color: 'white', modelo: 'aaa'})
        ...
        it('should return bike with code 1', (done)=>{
            Bicicleta.allBicis(function(err, bicis){
                ...
                Bicicleta.add(bici, function(err, newBike){
                    ...
                    let bici2 = new Bicicleta({code: 2, color: 'verde', modelo: 'urbana'})
